...
<body>
    <div class="single-form-bg">
        ...
        <form id="newability" method='post' class="single-form w3-container" action='newability.php'>
            ...
            <p class="tooltip" title="This is a short description of the power. Please keep it short, one or two sentences.">
                ...
                <textarea id="spelldesc" required name="spell_desc" class="w3-border-blk"> </textarea>
            </p>
            <p class="tooltip" title="A significantly more detailed desription. Be as lengthy as you wish.">
                ...
                <textarea id="spelldesc2" required  name="spell_desc2" class="w3-border-blk"></textarea>
            </p>
