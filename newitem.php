...
<body>
    <div class="w3-pale-purple-box">
        <h3 class="w3-display-header">New Item</h3>
        <?php
        ...
        <form id="newitem" method="post" class="w3-light-purple-box w3-container" action="newitem.php">
            ...
            <p class="tooltip" title="This is the size of the item. Can be in relation to character. If units, please list the units.">
                ...
                <input type="text" id="itemsize" name="item_size" class='w3-input'>
            </p>
            ...
            <p class="tooltip" title="The value of the item. This area is not required, but can be used if so desired.">
                ...
                <input type="text" id="itemvalue" name="item_value" class='w3-input'>
            </p>
            <?php
